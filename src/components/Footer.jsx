...
const Footer = () => {
  return (
    <footer className=" bg-[#eee] mt-8">
  <div className="max-w-screen-xl px-4 pt-16 pb-6 mx-auto sm:px-6 lg:px-8 lg:pt-24">
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        <div className="flex justify-center sm:justify-start">
         <h1 className='text-highlight font-bold text-[3vh] sm:text-[2vw]  '>LICON ELEVATOR</h1>
        </div>
        ...
        <ul className="flex justify-center gap-6 mt-8 md:gap-8 sm:justify-start">
          <li>
            <a
              ...
              target="_blank"
              className="text-highlight transition hover:text-highlight/75"
            >
      ...
      >
        ...
        <div className="text-center sm:text-left">
          <p className="text-lg font-medium text-highlight">Our Services</p>
        ...
        <div className="text-center sm:text-left">
          <p className="text-lg font-medium text-highlight">Contact Us</p>
            ...
            <li>
              ...
              >
                <svg
                  ...
                  className="w-5 h-5 text-highlight shrink-0"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth="2"
